...
const links = [
  ...
  { key: "causes", href: "/causes/consultation", text: "Consultas", icon: BiSolidChat },
  { key: "causes", href: "/causes/documents", text: "Documentos", icon: IoDocuments },
  { key: "", href: "title", text: "CONTABLE", icon: "" },
  { key: "agreements", href: "/agreements", text: "Acuerdos", icon: MdOutlineHandshake },
  ...
  { key: "statistic", href: "/statistic/sales", text: "Ventas", icon: FaChartBar },
  { key: "statistic", href: "/statistic/legals", text: "Legales", icon: SlPieChart },
  { key: "statistic", href: "/statistic/marketing", text: "Marketing", icon: SiSimpleanalytics },
  { key: "statistic", href: "/statistic/finances", text: "Contable", icon: MdOutlineAttachMoney },
