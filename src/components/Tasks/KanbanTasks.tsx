...
const TaskKanban: React.FC = () => {
  ...
  const [tasks, setTasks] = useState([
    {
      id: 1,
      title: "Esto es una tarjeta de oportunidad",
    ...
    },
    {
      id: 4,
      title: "Esto es una tarjeta de oportunidad",
      column: "2-REUNIÓN A CONCRETAR",
    },
    {
      id: 5,
      title: "Esto es una tarjeta de oportunidad",
      column: "3-REUNIÓN COORDINADA",
    },
    {
      id: 6,
      title: "Esto es una tarjeta de oportunidad",
      column: "4-EN TRATAMIENTO",
    },
    {
      id: 7,
      title: "Esto es una tarjeta de oportunidad",
      column: "5-PENDIENTE DE CONFIRMACIÓN",
    },
    {
      id: 8,
      title: "Esto es una tarjeta de oportunidad",
      column: "6-COORDINAR REUNIÓN PODER",
    },
    {
      id: 9,
      title: "Esto es una tarjeta de oportunidad",
      column: "7-REUNIÓN DE PODER",
    },
    {
      id: 10,
      title: "Esto es una tarjeta de oportunidad",
      column: "8-PENDIENTE PODER",
    },
    {
      id: 11,
      title: "Esto es una tarjeta de oportunidad",
      column: "9-GANADO - TRAJO PODER",
    },
    {
      id: 12,
      title: "Esto es una tarjeta de oportunidad",
  ...
  return (
    <>
      <div className="mx-auto ">
        ...
        <div className="mt-9 flex gap-7.5 overflow-x-auto sm:grid-cols-2 xl:grid-cols-3">
          {columns.map((column) => (
            <div key={column} className="swim-lane flex flex-col gap-5.5">
              <h4 className="w-[400px] text-xl font-semibold text-black dark:text-white">
                {column}
              </h4>
              {tasks
