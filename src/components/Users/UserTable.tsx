...
const columns = [
  ...
  { name: "Apellido y Nombre", uid: "lastnameFirstname", sortable: true },
  { name: "Correo electrónico", uid: "email", sortable: true },
...
const UserTable: React.FC = () => {
  ...
  }, [filterValue, onSearchChange, onRowsPerPageChange, data.length, onClear]);
