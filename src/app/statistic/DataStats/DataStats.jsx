      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4 ">
        <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 dark:border-strokedark xl:border-b-0 xl:border-r xl:pb-0">
          <div className="">
            ...
            <p className="text-sm font-medium">En junio se generaron 13 leads, una disminución del 86% respecto al mes anterior que fueron 94.</p>
          </div>
        ...
        <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 dark:border-strokedark xl:border-b-0 xl:border-r xl:pb-0">
          <div>
            ...
            <p className="text-sm font-medium">En junio hay 20 leads en progreso, un aumento del 43% respecto al mes anterior que fueron 14.</p>
          </div>
        ...
        <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 dark:border-strokedark sm:border-b-0 sm:pb-0 xl:border-r">
          <div>
            ...
            <p className="text-sm font-medium">En junio hay 9 leads en estado "ganados", lo cual representa una disminución del 10% respecto al mes anterior que fueron 10.</p>
          </div>
          <div className="flex items-center gap-1">
            <svg
              width="19"
        ...
        <div className="flex items-center justify-center gap-2">
          <div>
            ...
            <p className="text-sm font-medium">En junio hay 1 leads en estado "perdidos", lo cual representa una disminución del 94% respecto al mes anterior que fueron 16.</p>
          </div>
          <div className="flex items-center gap-1">
            <svg
              width="19"
